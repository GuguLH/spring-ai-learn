...
import top.gugulh.ai.entity.vo.Result;
import top.gugulh.ai.repository.IChatHistoryRepository;
import top.gugulh.ai.repository.IFileRepository;
...
public class PdfController {
    ...
    public Flux<String> pdfChat(
        ...
        return pdfChatClient.prompt()
                ...
                .advisors(advisorSpec -> advisorSpec.param(FILTER_EXPRESSION, "file_name == '" + file.getFilename() + "'"))
                .stream() // 流式响应
                .content();
    }
